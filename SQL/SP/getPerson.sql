...
BEGIN
	DECLARE @resultR int;
	BEGIN TRY
		DECLARE @result Table (Cedula varchar(50),Nombre varchar(50), Apellido1 varchar(50),  Apellido2 varchar(50), Sexo int, FechaCaducacion DateTime, CodigoJunta varchar(50), Provincia varchar(50), Canton varchar(50), Distrito varchar(50));
		...
		INSERT INTO @result SELECT Cedula, Nombre, Apellido1, Apellido2, Sexo, FechaCaducacion, @CodigoJunta, @Provincia, @Canton, @Distrito
